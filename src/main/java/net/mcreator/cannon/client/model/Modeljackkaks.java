...
public class Modeljackkaks<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cannon", "modeljackkaks"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = Helmet.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(52, 69).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Helmet.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(72, 0).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.7F, -6.0F, 5.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition cube_r7 = Helmet.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(16, 72).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Chestplate = partdefinition.addOrReplaceChild("Chestplate",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r16 = Chestplate.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(44, 57).addBox(-1.0F, -2.0F, -1.0F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.3F, 11.0F, -1.8F, 0.0873F, 0.1745F, -0.0436F));
		PartDefinition cube_r17 = Chestplate.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(17, 4).addBox(-4.0F, -2.0F, -1.0F, 12.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
