...
public class Modelbillkolme<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cannon", "modelbillkolme"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = Helmet.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(12, 47).addBox(1.0F, -2.0F, -1.0F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = Helmet.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(14, 47).addBox(0.0F, 0.0F, -1.0F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = Helmet.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(0, 20).addBox(0.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -9.9F, -0.1F, 0.0F, -0.2182F, 0.4363F));
		PartDefinition cube_r22 = Helmet.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(4, 20).addBox(0.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLegging = partdefinition.addOrReplaceChild("RightLegging",
				CubeListBuilder.create().texOffs(49, 39).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(18, 25).addBox(-1.0F, 0.0F, -2.1F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(24, 15)
						.addBox(-2.0F, 5.0F, -2.1F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 11).addBox(-2.0F, 5.0F, -2.1F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));
		PartDefinition LeftLegging = partdefinition.addOrReplaceChild("LeftLegging", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				.addBox(-2.0F, 5.0F, -2.1F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(2.1F, 5.0F, -2.1F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));
