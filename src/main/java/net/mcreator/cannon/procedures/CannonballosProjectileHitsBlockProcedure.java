...
public class CannonballosProjectileHitsBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.FLAME, x, y, z, 10, 1, 1, 0.3, 2);
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.SMOKE, x, y, z, 10, 1, 0.2, 1, 2);
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.CAMPFIRE_COSY_SMOKE, x, y, z, 10, 1, 0.1, 0.1, 2);
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.LARGE_SMOKE, x, y, z, 10, 1, 0.3, 1, 2);
	}
}
