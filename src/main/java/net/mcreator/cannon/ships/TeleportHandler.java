...
public class TeleportHandler {
	...
	private static final Map<Long, Set<Integer>> shipIdToConstraints = ((net.mcreator.cannon.mixins.ServerShipObjectWorldAccessor) VSGameUtilsKt.getShipObjectWorld(ValkyrienSkiesMod.getCurrentServer())).getShipIdToConstraints();
	private static final Map<Integer, VSConstraint> constraintIdToConstraint = ((net.mcreator.cannon.mixins.ServerShipObjectWorldAccessor) VSGameUtilsKt.getShipObjectWorld(ValkyrienSkiesMod.getCurrentServer())).getConstraints();
