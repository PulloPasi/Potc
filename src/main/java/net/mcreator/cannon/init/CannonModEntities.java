...
public class CannonModEntities {
	...
	public static final RegistryObject<EntityType<DavyJonesBossEntity>> DAVY_JONES_BOSS = register("davy_jones_boss",
			EntityType.Builder.<DavyJonesBossEntity>of(DavyJonesBossEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(DavyJonesBossEntity::new)
