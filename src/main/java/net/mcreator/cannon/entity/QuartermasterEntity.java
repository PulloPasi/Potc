	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
			...
			public boolean canUse() {
				double x = QuartermasterEntity.this.getX();
				double y = QuartermasterEntity.this.getY();
				double z = QuartermasterEntity.this.getZ();
				Entity entity = QuartermasterEntity.this;
				Level world = QuartermasterEntity.this.level();
