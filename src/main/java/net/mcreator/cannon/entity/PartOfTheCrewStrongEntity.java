...
public class PartOfTheCrewStrongEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PartOfTheCrewStrongEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PartOfTheCrewStrongEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PartOfTheCrewStrongEntity.class, EntityDataSerializers.STRING);
	...
	public PartOfTheCrewStrongEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CannonModEntities.PART_OF_THE_CREW_STRONG.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "herramies");
	}
	...
	public static void init() {
		SpawnPlacements.register(CannonModEntities.PART_OF_THE_CREW_STRONG.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PartOfTheCrewStrongEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
