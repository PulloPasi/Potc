...
import net.mcreator.cannon.procedures.BlackBeardCrewAttackConditionProcedure;
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
			...
			public boolean canUse() {
				double x = BlackBeardsCrewEntity.this.getX();
				double y = BlackBeardsCrewEntity.this.getY();
				double z = BlackBeardsCrewEntity.this.getZ();
				Entity entity = BlackBeardsCrewEntity.this;
				Level world = BlackBeardsCrewEntity.this.level();
				return super.canUse() && BlackBeardCrewAttackConditionProcedure.execute(entity);
			}
