...
import net.mcreator.cannon.procedures.SwordoftritonprojectileProjectileHitsLivingEntityProcedure;
...
public class SwordoftritonprojectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public SwordoftritonprojectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(CannonModEntities.SWORDOFTRITONPROJECTILE.get(), world);
	}

	public SwordoftritonprojectileEntity(EntityType<? extends SwordoftritonprojectileEntity> type, Level world) {
		super(type, world);
	}

	public SwordoftritonprojectileEntity(EntityType<? extends SwordoftritonprojectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public SwordoftritonprojectileEntity(EntityType<? extends SwordoftritonprojectileEntity> type, LivingEntity entity, Level world) {
	...
	public static SwordoftritonprojectileEntity shoot(LivingEntity entity, LivingEntity target) {
		SwordoftritonprojectileEntity entityarrow = new SwordoftritonprojectileEntity(CannonModEntities.SWORDOFTRITONPROJECTILE.get(), entity, entity.level());
