...
public class Modeljack<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "jack"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = Helmet.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(52, 69).addBox(-1.0F, -2.0F, -1.0F, 1.0F, 10.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Helmet
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(72, 0).addBox(-1.0F, -2.0F, -1.0F, 1.0F, 10.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(1.7F, -6.0F, 5.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r7 = Helmet.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(16, 72).addBox(-1.0F, -2.0F, -1.0F, 1.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r31 = Chestplate.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(18, 49)
						.addBox(-4.0F, -2.0F, -3.0F, 1.0F, 19.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(52, 21)
						.addBox(5.0F, -2.0F, -3.0F, 1.0F, 19.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 49)
						.addBox(-3.0F, -2.0F, 0.0F, 8.0F, 19.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLegging = partdefinition.addOrReplaceChild("RightLegging",
				CubeListBuilder.create().texOffs(62, 32)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(58, 16)
						.addBox(-2.0F, 5.0F, -3.0F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));

		PartDefinition LeftLegging = partdefinition.addOrReplaceChild("LeftLegging",
				CubeListBuilder.create().texOffs(34, 25)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(54, 44)
						.addBox(-1.8F, 5.0F, -3.0F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition LeftBoot = partdefinition.addOrReplaceChild("LeftBoot", CubeListBuilder.create().texOffs(66, 53)
		...
		PartDefinition RightBoot = partdefinition.addOrReplaceChild("RightBoot", CubeListBuilder.create()
				.texOffs(62, 65).addBox(-2.1F, 8.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));
